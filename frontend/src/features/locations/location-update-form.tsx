...
import { useLocationUpdate } from "@/entities/locations/hooks/use-location-update";
import {
  addressValidation,
  LocationDto,
...
export const LocationUpdateForm = ({
  ...
  const { locationUpdateAsync, isPending, error } = useLocationUpdate();
